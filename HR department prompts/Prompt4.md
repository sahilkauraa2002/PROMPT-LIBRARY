...
This prompt is used during the candidate communication stage, specifically after shortlisting. It helps HR draft professional interview invitation emails that include all necessary details such as timing, format, and guidelines.

**Problem Being Solved**

HR teams spend time repeatedly drafting emails, which can lead to inconsistency and errors. Missing details or unclear communication can negatively impact candidate experience. This prompt standardises communication and ensures all required information is included.

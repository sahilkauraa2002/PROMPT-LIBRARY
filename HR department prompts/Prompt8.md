...
This prompt is used in the pre-onboarding stage, where HR requests documents from selected candidates.

**Problem Being Solved**

Repetitive follow-ups waste time and can lead to communication gaps. This prompt standardises requests.
